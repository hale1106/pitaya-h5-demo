...
REM set path
set backup_path=E:\backup\pitaya-h5-demo\course
set project_path=E:\workspace\pitaya-h5-demo\course
set publish_path=D:\project\WebPublish\pitaya-h5-demo\course
set static_publish_path=D:\project\staticPublish\pitaya-h5-demo\course
